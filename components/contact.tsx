      ...
      <div className="mx-auto max-w-5xl px-5 md:px-8">
        <Reveal className="text-center">
          ...
          <h2 className="mt-7 font-heading text-3xl font-medium leading-tight tracking-tight text-balance text-gold-gradient sm:text-4xl md:text-5xl">
            Speak With Our A-Z Team Today
          </h2>
          <p className="mt-5 text-pretty leading-relaxed text-muted-foreground">
            Whether you're just starting to explore the real estate market and options in Jerusalem, or already working with us, choose the most convenient way to get in touch and we'll be happy to guide you.
          </p>
        </Reveal>
