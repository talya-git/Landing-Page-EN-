...
const features = [
  { icon: Eye, text: "On-site visits and property inspections" },
  { icon: ClipboardCheck, text: "Supervision and quality control" },
  { icon: Video, text: "Regular updates via video and reports" },
  { icon: Settings2, text: "Managing professionals and making decisions on your behalf" },
]
...
export function Overseas() {
  return (
    <section id="overseas" className="relative overflow-hidden py-14 md:py-20">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-background via-background/70 to-background/95" />
      ...
      <div className="relative mx-auto max-w-3xl px-5 text-center md:px-8">
        <Reveal>
          ...
          <h2 className="mt-4 font-heading text-3xl font-medium leading-tight tracking-tight text-balance text-gold-gradient sm:text-4xl md:text-5xl">
            We are your eyes, ears, and hands in Israel
          </h2>
          <p className="mt-6 text-pretty leading-relaxed text-muted-foreground">
            Living in the US, Canada, UK, France, or anywhere else in the world? Continue your daily life knowing someone is protecting your interests in Israel.
          </p>
        </Reveal>
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2">
          {features.map((f, i) => (
            <Reveal key={f.text} delay={i * 80}>
              <div className="flex items-center gap-4 rounded-xl border border-border/70 bg-card/70 p-5 text-left backdrop-blur-sm">
