      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 md:grid-cols-2 md:gap-16 md:px-8">
        ...
        <Reveal className="order-1 md:order-1" delay={120}>
          ...
          <p className="mt-4 text-pretty leading-relaxed text-muted-foreground">
            Having guided thousands of buyers from Jewish communities worldwide and from Israel over the past three decades, we've gained experience that allows us to make the purchasing process professional and enjoyable, bringing you to your housewarming with a big smile.
          </p>
        </Reveal>
      </div>
    </section>
